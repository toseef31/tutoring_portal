        ...
        <div class="row">
          ...
          <form class="form-horizontal employers-form" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                  ...
                  <div class="col-md-6">
                      <input type="text" class="form-control" name="first_name" required="" value="{{ $admin->first_name }}">
                  </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group radio-div">
                  ...
                  <div class="col-md-6 radio-div">
                      <label class="custom-control custom-control-primary custom-radio">
                          <input name="role" class="custom-control-input" type="radio" value="admin" {{ $admin->role == 'admin' ? 'checked="checked"' : '' }}>
                      ...
                      <label class="custom-control custom-control-primary custom-radio" style="margin-left:20px;">
                          <input name="role" class="custom-control-input" type="radio" value="tutor" {{ $admin->role == 'tutor' ? 'checked="checked"' : '' }}>
                          <span class="custom-control-indicator"></span>
