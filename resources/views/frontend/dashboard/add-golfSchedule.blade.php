				...
				<div class="cards">
					<div class="row" style="padding: 20px;">
						<div class="col-md-offset-2 col-md-8 text-center">
							<a class="btn btn-success btn-lg" href="{{url('/dashboard/golf-form')}}" style="width: 33%;"> <i class="fa fa-home"></i> Reservation List</a>
							<a class="btn btn-success btn-lg"  href="{{url('/dashboard/golf-form')}}" style="width: 33%;"> <i class="fa fa-list"></i> Schedule</a>
						</div>	
					</div>
