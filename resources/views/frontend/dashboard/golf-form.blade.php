			...
			<div class="row">
				...
				<div class="row" style="padding: 20px;">
					<div class="col-md-offset-3 col-md-6 text-center">
						...
						<button class="btn btn-success btn-lg" id="category"> <i class="fa fa-list"></i> Schedule</button>
					</div>	
				</div>
				...
				<div class="row" style="margin: 30px auto;display: none;" id="categoryTable">
					<div class="col-md-offset-1 col-md-10">
						<div class="table-responsive">
							<a class="btn btn-danger"  href="{{url('/dashboard/add-golfSchedule')}}" style="margin-bottom: 5px;"><i class="fa fa-plus"></i> Add an Event</a>
								<table class="table table-striped">
									<thead>
