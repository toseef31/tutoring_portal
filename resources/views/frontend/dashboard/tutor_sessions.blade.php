              ...
              <div class="" style="margin-top:20px;">
                ...
                <ul style="list-style-type: none;">
                  ...
                  $time = date('h:i a', strtotime($session->time))
                   ?>
                  <li><a href="{{url('user-portal/tutor-sessions-details/'.$session->session_id)}}" style="background: #10C5A7;color: white;border-radius: 4px;"><span style="padding: 10px;">{{$time}} {{$session->date}} {{$session->subject}} Session</span> </a></li>
                  @endforeach
                </ul>
                @else
