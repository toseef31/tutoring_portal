...
@section('title', 'Video & Chat Payment')
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div style="padding-left: 22px;padding-right: 13px;">
                        ...
                        <form class="form-horizontal" method="POST" id="payment-form" role="form" action="{{url('/dashboard/buyvideo')}}" >
                            {{ csrf_field() }}
                ...
                <div class="" style="padding-left: 22px;padding-right: 13px;">
                    ...
                    <form action="{{url('nicepay/payRequest_utf.php')}}" method="post" id='nicepckg'> 
                       <input type="hidden" value="{{Session::get('pckgdata')['package_price']}}" name="price" >
                        <input type="hidden" value="1" name="goodscount" >
                        <input type="hidden" value="searchbysearch" name="goodsName" >
                        <input type="hidden" value="{{Session::get('bkyUser')->user_email}}" name="Email" >
                        <input type="hidden" value="{{Session::get('bkyUser')->user_mobileNumber}}" name="tel" >
                        <input type="hidden" value="{{Session::get('pckgdata')['pckg_id']}}" name="buyerName" id='buyer' >
                     
                        <button type="submit"  class="btn btn-info btn-lg nicePay">@lang('home.NicePay')</button>
                    </form>
                </div>
                </div>
            </div>
